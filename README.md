...
google-map-react - maps,
date-fns && moment - for dates,
react-infinite-scroller - scroll,
react-dropzone - drag'n'drop,
revalidate - validations,
react-redux-toastr - popup messages,
react-places-autocomplete - autocomplete for Google maps,
react-loadable - code splitting && dynamic imports
